...
void Send_Sensors(){
  ...
  pressure.number =(uint16_t) (tSensors->getPressure()/10); //÷3
  Serial.print("Pressure: "); Serial.println((float)pressure.number*10); //*3
  ...
  x_g.number = (int16_t) (xyz_g->x_g * 1000);  //*250
  y_g.number = (int16_t) (xyz_g->y_g * 1000);  //*250
  z_g.number = (int16_t) (xyz_g->z_g * 1000);  //*250
  Serial.print("Acc X: "); Serial.println((float)x_g.number/1000); //÷250
  Serial.print("Acc Y: "); Serial.println((float)y_g.number/1000); //÷250
  Serial.print("Acc Z: "); Serial.println((float)z_g.number/1000); //÷250
  Serial.print("\0");
  free(xyz_g);
